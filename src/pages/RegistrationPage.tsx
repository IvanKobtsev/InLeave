      ...
      <div className={styles.RegistrationForm}>
        ...
        <div className={styles.rightSide}>
            <div className={styles.blockForm}>
                ...
                <input type="text" name="password" placeholder="Second name" /><br />
                <p  className={styles.formSubTitle}>Имя</p>
                <input type="text" name="password" placeholder="First name" /><br />
                <p  className={styles.formSubTitle}>Отчество</p>
                <input type="text" name="password" placeholder="Third name" /><br />
                <button className={styles.rightSideButton}>Зарегистрироваться</button>
            </div>
